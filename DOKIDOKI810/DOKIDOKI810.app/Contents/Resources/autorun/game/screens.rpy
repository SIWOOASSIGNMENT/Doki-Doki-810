...
screen navigation():
    ...
    vbox:
        ...
        if main_menu:
            ...
            textbutton _("대사보기") action ShowMenu("history")
        ...
        textbutton _("게임정보") action ShowMenu("about")
...
screen about():
    ...
    use game_menu(_("게임정보"), scroll="viewport"):
        ...
        vbox:
            ...
            text _("이 게임은 중앙대학교 예술공학대학 과제 제출을 목적으로 제작되었습니다.\n절대로 악의는 없으며 저희는 교수님을 존경하고 있음을 밝힙니다.\n\n기획:김시우\nGUI:김시우\n디자인: 신지현\n개발:김시우 신지현")
    ...
    use game_menu(_("조작방법"), scroll="viewport"):
        ...
        vbox:
            ...
            hbox:
                ...
                textbutton _("대사") action SetScreenVariable("device", "keyboard")
                textbutton _("미니게임") action SetScreenVariable("device", "mouse")
